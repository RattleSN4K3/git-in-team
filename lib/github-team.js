...
export default class GitHubTeamData extends EventEmitter {
  ...
  onDataReceived_Public(err, res){
    note("Data public");
    this._OutputToJson('github_public.json', res.body);
  ...
  onDataReceived_Members(err, res){
    ...
    this._OutputToJson('github_members_body.json', res.body);
    this._OutputToJson('github_members_res.json', res);
  ...
  onDataReceived_Teams(err, res){
    ...
    if (res.status == 200) {
      this._OutputToJson('github_teams.json', res.body);
  ...
  onDataReceived_Team(err, res){
    ...
    this._OutputToJson('github_team.json', res.body);
  ...
  onResponse_AddToTeam(err, res, fn){
    ...
    this._OutputToJson('github_user.json', res.body);
  ...
  onResponse_AddedToTeam(err, res, fn){
    ...
    this._OutputToJson('github_user_response.json', res.body);
  ...
  _OutputToJson(filename, rawdata){
